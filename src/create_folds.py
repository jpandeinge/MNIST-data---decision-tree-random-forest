...
if __name__ == '__main__':
    ...
    df_train = pd.read_csv('/home/jpandeinge/Dev/data_science/NLP/mnist/input/mnist_train.csv')
    ...
    df_train.to_csv('/home/jpandeinge/Dev/data_science/NLP/mnist/input/mnist_train_folds.csv', index=False)
